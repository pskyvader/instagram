...
class Bot(object):
    def __init__(
        ...
        self.sleep = {
            ...
            "unlike": unlike_sleep,
            "follow": follow_sleep,
            "unfollow": unfollow_sleep,
            "comment": comment_sleep,
            "block": block_sleep,
            "unblock": unblock_sleep,
            "message": message_sleep,
            "get": get_sleep,
        }
        self.last_sleep = {key: 0 for key in self.sleep.keys()}
        ...
        self.followed_date_file = utils.file(followed_date_file)
    ...
    def print_counters(self):
        ...
        self.console_print("Total requests: {}".format(self.api.total_requests))
    ...
    def console_print(self, text, color=None, progress=None):
        return console_print(self, text, color, progress)
