...
class backup(base):
    ...
    def actualizar_tiempo(self):
        ...
        if "tiempo" in campos and "tipo_backup" in campos:
            cantidad = configuracion_model.getByVariable( "cantidad_backup_" + campos["tipo_backup"],0)
            tiempo = configuracion_model.getByVariable( "tiempo_backup_" + campos["tipo_backup"] ,0)
