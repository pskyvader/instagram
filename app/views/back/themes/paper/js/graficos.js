...
function chart_followers() {
    ...
    post_basic(url, {}, 'Adquiriendo usuarios', function(data) {
        ...
        div.selectAll(".venn-circle path").style("fill-opacity", .3).style("stroke-width", 3).style("stroke-opacity", 1);
        ...
        div.selectAll("g")
            .on("mouseover", function(d, i) {
                ...
                selection.select("path").style("stroke-width", 3).style("fill-opacity", d.sets.length == 1 ? .5 : (d.sets.length > 1 ? .1 : 0)).style("stroke", "fff");
            })
            ...
            .on("mouseout", function(d, i) {
                ...
                selection.select("path").style("stroke-width", 3).style("fill-opacity", d.sets.length == 1 ? .3 : 0).style("stroke", "none");
            });
    });
}
